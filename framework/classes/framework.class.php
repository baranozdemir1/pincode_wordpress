...
class CSFramework extends CSFramework_Abstract {
  ...
  public function admin_page() {
    ...
    echo '<div class="cs-framework cs-option-framework">';
      ...
      echo '<div class="cs-block-left">Powered by <a target="_blank" href="https://www.r10.net/members/109809-baran_ozdemir.html" class="a-etiketi">Baran Özdemir</a></div>';
      echo '<div class="cs-block-right">PinCode</div>';
      echo '<div class="clear"></div>';
